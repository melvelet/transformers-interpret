...
# 	python generate_qualitative_viz.py -m 1 -d 4 -ent 1 -doc Rituximab -ref1 16 -ref2 18
	...
	python generate_qualitative_viz.py -m 1 -d 4 -ent 1 -doc 76 -ref1 142 -ref2 145
	python generate_qualitative_viz.py -m 1 -d 4 -ent 1 -doc 75 -ref1 61 -ref2 96
	python generate_qualitative_viz.py -m 2 -d 4 -ent 1 -doc 358 -ref1 355 -ref2 337
