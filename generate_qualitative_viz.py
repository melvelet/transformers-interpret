...
for collapse_threshold in [0.05, 0.02, 0.1]:
    ...
    with open(f"results/viz/example_{'bioelectra' if args.model_no == 1 else 'roberta'}_{dataset_names[args.dataset_no]}_doc={doc_id}_ref1={mod1_ref_token_idx}_ref2={mod2_ref_token_idx}_k={k_value}.txt", 'w+') as f:
